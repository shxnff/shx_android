 ...
 * </br>
 */
public class ShxProgressBar extends View implements Runnable{
    ...
    public ShxProgressBar(Context context) {
        this(context, null, 0);
    }

    public ShxProgressBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShxProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        initAttrs(attrs);
    }

    private void initAttrs(AttributeSet attrs) {
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.ShxProgressBar);
        try {
            textSize = (int) ta.getDimension(R.styleable.ShxProgressBar_textSize, 12);
            loadingColor = ta.getColor(R.styleable.ShxProgressBar_loadingColor, Color.parseColor("#40c4ff"));
            stopColor = ta.getColor(R.styleable.ShxProgressBar_stopColor, Color.parseColor("#ff9800"));
            radius = (int) ta.getDimension(R.styleable.ShxProgressBar_radius, 0);
            borderWidth = (int) ta.getDimension(R.styleable.ShxProgressBar_borderWidth, 1);
        } finally {
            ta.recycle();
        }
    }
    ...
    private void init() {
        ...
        flikerBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.shx_flicker2);
