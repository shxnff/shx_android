...
public class LoadMoreFoot extends InternalClassics<LoadMoreFoot> implements RefreshFooter {
    ...
    public LoadMoreFoot(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lpProgress.width = ta.getLayoutDimension(R.styleable.ClassicsFooter_srlDrawableProgressSize, density.dip2px(16));
        lpProgress.height = ta.getLayoutDimension(R.styleable.ClassicsFooter_srlDrawableProgressSize, density.dip2px(16));
        ...
        mFinishDuration = ta.getInt(R.styleable.ClassicsFooter_srlFinishDuration, 0);
